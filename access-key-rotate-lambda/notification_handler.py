...
def format_notifier_payload(context, account_id, account_name, recipient_emails, action_queue,
...
def send_to_notifier(context, account_id, account_name, recipient_emails, action_queue, dryrun,
                     email_template):
    lambdaPayloadEncoded = format_notifier_payload(context, account_id, account_name,
                                                   recipient_emails, action_queue,
                                                   dryrun, email_template)
